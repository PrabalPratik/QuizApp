...
def contact_view(request):
    ...
    if request.method == "POST":
        ...
        if subject is not None and message is not None:
            ...
            form.save()
            messages.success(request, "Message Received. We will resolve your query soon.")
...
def search_users_view(request):
    ...
    if query:
     ...
     #select * from users where name like %hm% order by date_joined
    else:
        users = []
